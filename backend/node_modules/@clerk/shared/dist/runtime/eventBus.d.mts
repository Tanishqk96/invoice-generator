 ...
 */
type EventHandler<Events$1 extends Record<string, unknown>, Key extends keyof Events$1> = (payload: Events$1[Key]) => void;
/**
 * @interface
 * Strongly-typed event bus interface that enables type-safe publish/subscribe patterns
 */
type EventBus<Events$1 extends Record<string, unknown>> = {
  /**
   ...
   * @returns void
   */
  on: <Event extends keyof Events$1>(event: Event, handler: EventHandler<Events$1, Event>, opts?: {
    notify?: boolean;
  }) => void;
  /**
   ...
   * @returns void
   */
  prioritizedOn: <Event extends keyof Events$1>(event: Event, handler: EventHandler<Events$1, Event>) => void;
  /**
   ...
   * @returns void
   */
  emit: <Event extends keyof Events$1>(event: Event, payload: Events$1[Event]) => void;
  /**
   ...
   * @returns void
   */
  off: <Event extends keyof Events$1>(event: Event, handler?: EventHandler<Events$1, Event>) => void;
  /**
   ...
   * @returns void
   */
  prioritizedOff: <Event extends keyof Events$1>(event: Event, handler?: EventHandler<Events$1, Event>) => void;
  /**
  ...
  internal: {
     ...
     */
    retrieveListeners: <Event extends keyof Events$1>(event: Event) => Array<(...args: any[]) => void>;
  };
};
/**
...
//# sourceMappingURL=eventBus.d.mts.map