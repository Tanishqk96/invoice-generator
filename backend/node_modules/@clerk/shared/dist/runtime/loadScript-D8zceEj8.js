const require_retry = require('./retry-rhkPbMCS.js');
...
async function loadScript(src = "", opts) {
	...
	return require_retry.retry(load, { shouldRetry: (_, iterations) => iterations <= 5 });
}
...
//# sourceMappingURL=loadScript-D8zceEj8.js.map