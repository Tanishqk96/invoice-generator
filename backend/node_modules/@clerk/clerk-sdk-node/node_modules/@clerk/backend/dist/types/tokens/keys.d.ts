 ...
 * @returns {JsonWebKey} key
 */
export declare function loadClerkJWKFromRemote({ apiKey, secretKey, apiUrl, apiVersion, issuer, kid, skipJwksCache, }: LoadClerkJWKFromRemoteOptions): Promise<JsonWebKey>;
