...
export type CreateAuthenticateRequestOptions = {
    options: Partial<Pick<AuthenticateRequestOptions, 'audience' | 'apiKey' | 'secretKey' | 'apiUrl' | 'apiVersion' | 'frontendApi' | 'publishableKey' | 'jwtKey' | 'proxyUrl' | 'domain' | 'isSatellite' | 'userAgent'>>;
    apiClient: ApiClient;
};
export declare function createAuthenticateRequest(params: CreateAuthenticateRequestOptions): {
    ...
    remotePublicInterstitial: ({ frontendApi: runtimeFrontendApi, publishableKey: runtimePublishableKey, proxyUrl: runtimeProxyUrl, isSatellite: runtimeIsSatellite, domain: runtimeDomain, userAgent: runtimeUserAgent, ...rest }: LoadInterstitialOptions) => Promise<string>;
