...
type BlockingData<Data = any, Options = SWROptions<Data>> = SWRGlobalConfig extends {
    suspense: true;
...
type IsLoadingResponse<Data = any, Options = SWROptions<Data>> = SWRGlobalConfig extends {
    suspense: true;
} ? Options extends {
    suspense: true;
} ? false : false : boolean;
